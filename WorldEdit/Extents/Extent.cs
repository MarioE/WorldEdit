...
namespace WorldEdit.Extents
{
    ...
    {
        /// <summary>
        /// Gets the dimensions of this <see cref="Extent" /> instance.
        /// </summary>
        public abstract Vector Dimensions { get; }

        /// <summary>
        /// Adds the specified tile entity to this <see cref="Extent" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the tile located at the specified position in this <see cref="Extent" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the tile entities contained within this <see cref="Extent" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the specified position is within the bounds of this <see cref="Extent" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Modifies the tiles within the specified region in this <see cref="Extent" /> instance using the template.
        /// </summary>
        /// <param name="region">The region, which must not be <c>null</c>.</param>
        ...
        /// <summary>
        /// Modifies the tiles within the specified region in this <see cref="Extent" /> instance using the template and mask.
        /// </summary>
        /// <param name="region">The region, which must not be <c>null</c>.</param>
        /// <param name="template">The template, which must not be <c>null</c>.</param>
        ...
        /// <summary>
        /// Removes the specified tile entity to this <see cref="Extent" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Sets the tile located at the specified position in this <see cref="Extent" /> instance.
        /// </summary>
        /// <param name="position">The position, which must be within the bounds.</param>
