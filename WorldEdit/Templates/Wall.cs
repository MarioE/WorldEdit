...
namespace WorldEdit.Templates
{
    ...
    public sealed class Wall : ITemplate
    {
        ...
        /// <summary>
        /// Tries to parse the specified string into a <see cref="Wall" /> instance. A return value of <c>null</c> indicates
        /// failure.
        /// </summary>
        /// <param name="s">The string to parse, which must not be <c>null</c>.</param>
        /// <returns>The wall, or <c>null</c> if parsing failed.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="s" /> is <c>null</c>.</exception>
        /// <remarks>
        /// This method will parse strings of the form "type", where type can be a name or ID.
        /// </remarks>
        [CanBeNull]
        [Pure]
        public static Wall TryParse([NotNull] string s)
        {
            if (s == null)
            {
